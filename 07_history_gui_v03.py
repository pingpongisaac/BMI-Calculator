...
class HistoryExport:
    ...
    def make_file(self):
        ...
        if filename == "":
            ...
            filename = "{}_BMI_calculations".format(date_part)
    ...
    def write_to_file(self, filename):
        ...
        description = ("Below is the history of your BMI "
                       "calculations. It contains the height "
                       "and weight you entered, as well as "
                       "the corresponding BMI value. Enjoy.")
